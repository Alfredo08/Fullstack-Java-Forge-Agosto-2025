...
public class ServicioLibros {
    ...
    public Libro actualizarUno(Libro libro){
        return this.repositorioLibros.save(libro);
    }
    ...
    public void eliminarUno(Long idLibro){
        this.repositorioLibros.deleteById(idLibro);
    }
}
